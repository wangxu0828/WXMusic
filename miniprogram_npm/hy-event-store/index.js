...
__DEFINE__(1644651938969, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644651938970,"./event-store":1644651938971}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644651938970, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644651938971, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644651938970,"./utils":1644651938972}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644651938972, function(require, module, exports) {
...
return __REQUIRE__(1644651938969);
})()
