...
__DEFINE__(1645103540763, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1645103540764,"./event-store":1645103540765}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645103540764, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1645103540765, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1645103540764,"./utils":1645103540766}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645103540766, function(require, module, exports) {
...
return __REQUIRE__(1645103540763);
})()
