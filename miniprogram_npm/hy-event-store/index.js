...
__DEFINE__(1644842145919, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644842145920,"./event-store":1644842145921}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644842145920, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644842145921, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644842145920,"./utils":1644842145922}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644842145922, function(require, module, exports) {
...
return __REQUIRE__(1644842145919);
})()
