...
__DEFINE__(1645014733735, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1645014733736,"./event-store":1645014733737}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645014733736, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1645014733737, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1645014733736,"./utils":1645014733738}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645014733738, function(require, module, exports) {
...
return __REQUIRE__(1645014733735);
})()
